...
class _AllTransactionsScreenState
            ...
            children: [
              ...
              const Padding(
                ...
                child: Row(children: [
                  ...
                  SizedBox(width: 4),
                  Text('ধরে রাখো = Edit | বামে সোয়াইপ = Delete',
                    style: TextStyle(
  ...
  Widget _buildGroupedList(List<Transaction> filtered) {
    // Group by date
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        final dayBalance = txs.fold<double>(
            0,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '${dayBalance >= 0 ? '+' : ''}৳${dayBalance.toStringAsFixed(0)}',
                    style: TextStyle(
                      color: dayBalance >= 0
                          ? AppColors.teal
                          : AppColors.rose,
