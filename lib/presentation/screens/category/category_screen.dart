...
class _CategoryScreenState extends ConsumerState<CategoryScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final typeColor =
        isIncome ? AppColors.teal : AppColors.rose;
              ...
              child: TabBarView(
                ...
                children: [
                  _CategoryList(
                    ...
                    onAdd: () =>
                        _showAddDialog(TransactionType.income),
                    onDelete: (id) => ref
                        .read(categoriesProvider.notifier)
                        .remove(id),
                  ),
...
class _CategoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount =
        categories.fold<double>(0, (sum, cat) {
      final catTxs = allTxs
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    'মোট ${color == AppColors.teal ? 'আয়' : 'খরচ'}',
                    style: const TextStyle(
                      color: AppColors.textMuted,
                      fontSize: 12,
                    ),
...
class CategoryDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final total =
        liveTxs.fold<double>(0, (s, t) => s + t.amount);
    final isIncome =
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 12),
                        const Text(
                          'এই Category তে কোনো লেনদেন নেই',
                          style: TextStyle(
                            color: AppColors.textMuted,
                            fontSize: 14,
                          ),
