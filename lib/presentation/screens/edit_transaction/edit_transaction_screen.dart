...
class _EditTransactionScreenState
  ...
  Gradient get _typeGrad => _type == TransactionType.income
      ? AppColors.gradTeal
      : AppColors.gradRose;
  ...
  Future<void> _save() async {
    ...
    final updated = widget.transaction.copyWith(
      type: _type,
      category:
          _selectedCategory?.name ?? widget.transaction.category,
              ...
              child: Row(children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'আগের পরিমাণ: ৳${widget.transaction.amount.toStringAsFixed(0)}',
                      style: const TextStyle(
