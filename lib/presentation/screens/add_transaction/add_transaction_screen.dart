...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  Color get _typeColor => _type == TransactionType.income ? AppColors.teal : AppColors.rose;
  Gradient get _typeGrad => _type == TransactionType.income ? AppColors.gradTeal : AppColors.gradRose;
  ...
  Future<void> _save() async {
    ...
    await ref.read(transactionsProvider.notifier).add(
      ...
      note: _noteCtrl.text.isNotEmpty ? _noteCtrl.text : _selectedCategory!.name,
      date: _date,
  ...
  void _openCalculator() {
    showModalBottomSheet(
      ...
      builder: (_) => _CalculatorSheet(onResult: (result) => setState(() => _amountCtrl.text = result)),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final canSave = _amountCtrl.text.isNotEmpty && _selectedCategory != null;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.purple.withOpacity(0.15), borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: AppColors.purple.withOpacity(0.3))),
                  child: const Row(children: [
                    Text('🧮', style: TextStyle(fontSize: 16)),
                    SizedBox(width: 6),
                    Text('Calculator', style: TextStyle(color: AppColors.purple, fontSize: 12, fontWeight: FontWeight.w600)),
                  ])),
              ),
            ]),
                ...
                return Expanded(child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: isSelected ? [BoxShadow(color: _typeColor.withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 3))] : null),
                    alignment: Alignment.center,
                    child: Text(isIncome ? '↑  Income' : '↓  Expense',
                      style: TextStyle(color: isSelected ? Colors.white : AppColors.textMuted, fontSize: 14, fontWeight: FontWeight.w700)))));
              }).toList()),
            ),
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text('৳', style: TextStyle(color: _typeColor, fontSize: 28, fontWeight: FontWeight.w800, fontFamily: 'Syne')),
                  ...
                  Expanded(child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: '0.00', hintStyle: TextStyle(color: AppColors.textDim, fontSize: 40, fontFamily: 'Syne'),
                      border: InputBorder.none))),
                ]),
                const SizedBox(height: 8),
                Container(height: 2, decoration: BoxDecoration(gradient: _typeGrad, borderRadius: BorderRadius.circular(1))),
              ]),
            ),
            const SizedBox(height: 20),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Text('+ নতুন?', style: TextStyle(color: _typeColor, fontSize: 12, fontWeight: FontWeight.w600)),
            ]),
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: selected ? _typeColor.withOpacity(0.15) : Colors.white.withOpacity(0.04),
                            border: Border.all(color: selected ? _typeColor : Colors.white.withOpacity(0.07), width: 1.5),
                            borderRadius: BorderRadius.circular(14)),
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text(cat.icon, style: const TextStyle(fontSize: 22)),
                            const SizedBox(height: 4),
                            Text(cat.name,
                              style: TextStyle(color: selected ? _typeColor : AppColors.textMuted, fontSize: 10, fontWeight: FontWeight.w600),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'কীসের জন্য? (ঐচ্ছিক)', hintStyle: const TextStyle(color: AppColors.textDim, fontSize: 14),
              ...
              onTap: () async {
                final picked = await showDatePicker(
                  ...
                  builder: (ctx, child) => Theme(
                    data: ThemeData.dark().copyWith(colorScheme: const ColorScheme.dark(primary: AppColors.gold)), child: child!));
            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: canSave ? null : Colors.white.withOpacity(0.07),
                ...
                child: _saving
                    ...
                    : Text(canSave ? 'Save Transaction ✓' : 'পরিমাণ ও Category দিন',
                        style: TextStyle(color: canSave ? const Color(0xFF0A0E1A) : AppColors.textMuted,
...
class _CalculatorSheetState extends State<_CalculatorSheet> {
  ...
  void _press(String val) {
    setState(() {
      if (val == 'C') {
        _display = '0'; _expression = ''; _firstNum = null; _operator = null; _newInput = false;
      } else if (val == '⌫') {
        ...
        if (_firstNum != null && _operator != null) {
          final sec = double.tryParse(_display) ?? 0;
          double res = 0;
          if (_operator == '+') res = _firstNum! + sec;
          else if (_operator == '-') res = _firstNum! - sec;
          else if (_operator == '×') res = _firstNum! * sec;
          else if (_operator == '÷') res = sec != 0 ? _firstNum! / sec : 0;
          _expression = '$_expression $_display =';
          _display = res == res.truncate() ? res.toInt().toString() : res.toStringAsFixed(2);
          _firstNum = null; _operator = null; _newInput = true;
        }
      } else if (val == '.') {
        if (_newInput) { _display = '0.'; _newInput = false; }
        else if (!_display.contains('.')) _display += '.';
      } else {
        if (_newInput || _display == '0') { _display = val; _newInput = false; }
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 4),
          child: Align(alignment: Alignment.centerRight,
            child: Text(_expression, style: const TextStyle(color: AppColors.textMuted, fontSize: 13)))),
