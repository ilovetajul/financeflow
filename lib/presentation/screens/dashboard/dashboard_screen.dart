              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: 12,
                    itemBuilder: (_, i) {
                      final isSel = selectedMonth.month == i + 1 &&
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${months[selectedMonth.month - 1]} মাসের ব্যালেন্স',
                          style: TextStyle(
                        ...
                        Row(
                          children: [
                            _MiniStat(
                              label:
                                  '${months[selectedMonth.month - 1]} আয়',
                            ...
                            _MiniStat(
                              label:
                                  '${months[selectedMonth.month - 1]} খরচ',
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              'গত মাস (${months[lastMonth.month - 1]})',
                              style: const TextStyle(
                                color: AppColors.textPrimary,
                                fontSize: 13,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFF1A1040), Color(0xFF0D0A2E)],
                              ...
                              children: [
                                ...
                                Text(
                                  totalDebtNet == 0
                                      ? 'সব হিসাব সমান'
                                      : totalDebtNet > 0
                                          ? '৳${totalDebtNet.toStringAsFixed(0)} পাওনা আছে'
                                          : '৳${totalDebtNet.abs().toStringAsFixed(0)} দেনা আছে',
                                  style: TextStyle(
                                    color: totalDebtNet >= 0
                                        ? AppColors.teal
                                        : AppColors.rose,
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                  ...
                  child: Row(
                    children: [
                      ...
                      _StatCard(
                        ...
                        label: 'Category',
                        value:
                            '${filtered.map((x) => x.category).toSet().length}',
