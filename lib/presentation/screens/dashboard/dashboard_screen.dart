// dashboard_screen.dart এর header section এ
// শুধু এই import এবং header widget টা বদলাতে হবে

// এই import যোগ করো (উপরে অন্য imports এর সাথে):
// import '../profile/profile_screen.dart';

// Header widget টা এভাবে বদলাও:
  ...
  Row(
    ...
    children: [
      ...
      Row(children: [
        ...
        // Profile icon — ট্যাপ করলে profile screen খুলবে
        GestureDetector(
          onTap: () => Navigator.push(context,
...
// ── সহজ সমাধান: নিচের ফাইলটাই পুরো replace করো ──
...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final months = ['জানু','ফেব্রু','মার্চ','এপ্রিল','মে','জুন',
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const SizedBox(width: 8),
                        // Profile — ট্যাপ করলে Profile screen
                        GestureDetector(
                          onTap: () => Navigator.push(context,
                            MaterialPageRoute(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        onTap: () => ref.read(selectedMonthProvider.notifier)
                            .state = DateTime(now.year, i + 1),
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isSelected
                                ? null : Colors.white.withOpacity(0.06),
                          ...
                          child: Text(months[i],
                            style: TextStyle(
                              color: isSelected
                                  ? const Color(0xFF0A0E1A) : AppColors.textMuted,
                              fontSize: 12,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TweenAnimationBuilder<double>(
                          ...
                          builder: (_, val, __) => Text(_fmt(val),
                            style: const TextStyle(
                        ...
                        Row(children: [
                          _MiniStat(
                            label: '${months[selectedMonth.month - 1]} আয়',
                            value: _fmtShort(monthIncome),
                            color: AppColors.teal, arrow: '↑'),
                          const SizedBox(width: 10),
                          _MiniStat(
                            label: '${months[selectedMonth.month - 1]} খরচ',
                            value: _fmtShort(monthExpense),
                            color: AppColors.rose, arrow: '↓'),
                        ]),
                      ],
                    ),
                  ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: Row(children: [
                    _SummaryCard(title: 'আজকে',
                      income: todayIncome, expense: todayExpense, icon: '📅'),
                    const SizedBox(width: 10),
                    _SummaryCard(
                      title: 'এই সপ্তাহ',
                      income: weekTxs.where((t) => t.type == TransactionType.income)
                          .fold(0.0, (s, t) => s + t.amount),
                      expense: weekTxs.where((t) => t.type == TransactionType.expense)
                          .fold(0.0, (s, t) => s + t.amount),
                      icon: '📆'),
                  ]),
                ),
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              '${lastMonthBalance >= 0 ? '+' : ''}৳${lastMonthBalance.toStringAsFixed(0)}',
                              style: TextStyle(
                                color: lastMonthBalance >= 0
                      ...
                      Row(children: [
                        ...
                        Expanded(child: _LastMonthItem(
                          label: 'লেনদেন',
                          value: lastMonthTxs.length.toDouble(),
                          color: AppColors.gold, icon: '📊',
                          isCount: true)),
                      ]),
                    ]),
                  ),
...
class _LastMonthItem extends StatelessWidget {
  ...
  final Color color;
  final bool isCount;
  const _LastMonthItem({required this.label, required this.value,
